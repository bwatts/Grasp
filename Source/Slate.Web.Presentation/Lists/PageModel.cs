...
namespace Slate.Web.Presentation.Lists
{
	public class PageModel : ViewModel
	{
		...
		public static readonly Field<ListItems> ItemsField = Field.On<PageModel>.For(x => x.Items);

		public PageModel(NumberModel number, Count size, NumberModel firstItem, NumberModel lastItem, ListItems items)
		{
