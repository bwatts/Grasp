...
namespace Grasp.Hypermedia.Lists
{
	...
	{
		public static readonly Field<IReadOnlyDictionary<string, Type>> SchemaField = Field.On<ListItems>.For(x => x.Schema);
		...
		public ListItems(IReadOnlyDictionary<string, Type> schema, IEnumerable<ListItem> items)
		{
		...
		public IReadOnlyDictionary<string, Type> Schema { get { return GetValue(SchemaField); } private set { SetValue(SchemaField, value); } }
