...
namespace Grasp.Analysis.Compilation
{
	...
	/// </summary>
	public class GraspExecutable : Notion
	{
		public static readonly Field<GraspSchema> SchemaField = Field.On<GraspExecutable>.For(x => x.Schema);
		public static readonly Field<ICalculator> CalculatorField = Field.On<GraspExecutable>.For(x => x.Calculator);
