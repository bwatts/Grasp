...
namespace Grasp.Work.Items
{
	...
	{
		public static readonly Field<EntityId> WorkItemIdField = Field.On<WorkItemCreatedEvent>.For(x => x.WorkItemId);
		...
		public WorkItemCreatedEvent(EntityId workItemId, string description, TimeSpan retryInterval)
		{
