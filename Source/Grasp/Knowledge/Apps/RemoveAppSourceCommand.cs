...
{
	public class RemoveAppSourceCommand : EnvironmentCommand
	{
		public static readonly Field<AppSource> AppSourceField = Field.On<AddAppSourceCommand>.For(x => x.AppSource);

		public RemoveAppSourceCommand(FullName workItemName, FullName environmentName, AppSource appSource) : base(workItemName, environmentName)
		{
