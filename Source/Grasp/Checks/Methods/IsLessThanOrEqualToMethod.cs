...
{
	/// <summary>
	/// Produces check rules for the <see cref="Checkable.IsLessThanOrEqualTo{T}"/> method
	/// </summary>
	public sealed class IsLessThanOrEqualToMethod : ComparisonMethod
	{
		public static readonly Field<object> _valueField = Field.On<IsLessThanOrEqualToMethod>.For(x => x._value);
		...
		public IsLessThanOrEqualToMethod(object value)
		{
			_value = value;
		}

		/// <summary>
		/// Gets the <see cref="Checkable.IsLessThanOrEqualTo{T}"/> method
		/// </summary>
		...
		/// <returns>The <see cref="Checkable.IsLessThanOrEqualTo{T}"/> method</returns>
		protected override MethodInfo GetMethod(Type targetType, Type checkType)
		{
			return typeof(Checkable).GetMethod("IsLessThanOrEqualTo").MakeGenericMethod(targetType);
		}
