...
{
	public class GetIsLessThanRule : Behavior
	{
		int _value;
		...
		protected override void Given()
		{
			...
			_method = new IsLessThanMethod(_value);

			_expectedMethod = Reflect.Func<ICheckable<int>, int, Check<int>>(Checkable.IsLessThan);
		}
