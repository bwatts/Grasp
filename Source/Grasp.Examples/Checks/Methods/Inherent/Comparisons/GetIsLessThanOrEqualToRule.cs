...
{
	public class GetIsLessThanOrEqualToRule : Behavior
	{
		int _value;
		IsLessThanOrEqualToMethod _method;
		...
		protected override void Given()
		{
			...
			_method = new IsLessThanOrEqualToMethod(_value);

			_expectedMethod = Reflect.Func<ICheckable<int>, int, Check<int>>(Checkable.IsLessThanOrEqualTo);
		}
