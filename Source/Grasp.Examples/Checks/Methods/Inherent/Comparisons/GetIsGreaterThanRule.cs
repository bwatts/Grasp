...
{
	public class GetIsGreaterThanRule : Behavior
	{
		int _value;
		...
		protected override void Given()
		{
			...
			_method = new IsGreaterThanMethod(_value);

			_expectedMethod = Reflect.Func<ICheckable<int>, int, Check<int>>(Checkable.IsGreaterThan);
		}
