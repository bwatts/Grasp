...
{
	public class GetCheckConditionNegated : Behavior
	{
		CheckRule _rule;
		Type _targetType;
		...
		protected override void Given()
		{
			...
			_attribute = new TestCheckAttribute { Rule = _rule, TargetType = _targetType, Negate = true };
		}
		...
		[Then]
		public void HasNotRule()
		{
			Assert.That(_condition.Rule.Type, Is.EqualTo(RuleType.Not));
		}

		[Then]
		public void NotRuleHasCheckMethodRuleOperand()
		{
			var notRule = (NotRule) _condition.Rule;

			Assert.That(notRule.Rule, Is.EqualTo(_rule));
		}
