...
{
	public class CreateAnnotatedConditionSourceWithDefaultNameOverride : Behavior
	{
		Type _targetType;
		...
		[Then]
		public void HasOverriddenDefaultConditionName()
		{
			Assert.That(_source.DefaultConditionName, Is.EqualTo(TestTarget.NameOverride));
		}
